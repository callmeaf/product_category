...
namespace Callmeaf\ProductCategory\App\Http\Controllers\Api\V1;
...
class ProductCategoryController extends ApiController implements HasMiddleware
{
    ...
    {
        return $this->productCategoryRepo->latest()->builder(fn(Builder $query) => $query->active())->search()->paginate();
    }
