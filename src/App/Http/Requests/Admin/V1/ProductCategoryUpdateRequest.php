...
class ProductCategoryUpdateRequest extends FormRequest
{
    ...
    public function rules(ProductCategoryRepoInterface $productCategoryRepo): array
    {
        return [
            ...
            'parent_id' => ['nullable',Rule::exists($productCategoryRepo->getTable(),$productCategoryRepo->getModel()->getRouteKeyName())->where('type',$this->get('type'))->whereNot('slug',$this->route('product_category'))],
